...
This is a fork of the nf-core/rnaseq pipeline. It has been modified to include the following features:

- Run FastQC on the FastQ files filtered by SortMeRNA
